...
const features = [
  {
    ...
    description: "Every example, story, and exercise draws from Sierra Leonean daily life and WAEC standards."
  },
  {
    icon: Sparkles,
    title: "Adaptive AI tutoring",
    description: "Moe adjusts difficulty in real time, offering hints when needed and celebrating every win."
  },
  {
    icon: GraduationCap,
    title: "Progress tracking",
    description: "Guardians receive weekly summaries showing strengths, areas to review, and next steps."
  }
]
...
const steps = [
  {
    ...
    description: "Tell us your child's grade level and what you'd like them to master—reading, math, or creative writing."
  },
  {
    title: "Let Moe guide learning",
    description: "Students work through personalized lessons at their own pace, with Moe offering encouragement and feedback."
  },
  {
    title: "Monitor and celebrate",
    description: "Review detailed reports, track milestones, and watch confidence grow week by week."
  }
]
...
const safetyHighlights = [
  {
    ...
    description: "All interactions are encrypted and never shared without your permission."
  },
  {
    icon: Users,
    title: "Guardian oversight",
    description: "Access full transcripts anytime and set custom guardrails for content."
  },
  {
    icon: Sparkles,
    title: "Age-appropriate content",
    description: "Moe is trained to recognize sensitive topics and defer to guardians when needed."
  }
]
...
AI tutor for Sierra Leone
              ...
              <h4 className="text-balance text-lg font-bold leading-tight md:text-6xl">
Mi Ticha builds confident readers and problem solvers
              </h4>
              <p className="text-sm leading-relaxed text-white/80 md:text-xl">
              Moe, our friendly AI tutor, delivers homework help, guided reading practice, and crystal-clear progress insights so families can celebrate every milestone together.
            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 shadow-2xl backdrop-blur">
                <div className="relative aspect-[4/3]">
                  <Image src="/assets/ami.png" alt="Students learning with Moe" fill className="object-cover" priority />
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="features" className="mx-auto max-w-6xl px-6 py-20">
          <div className="md:flex md:items-end md:justify-between">
            <div className="max-w-2xl space-y-4">
              ...
              <h2 className="text-3xl font-bold tracking-tight md:text-4xl">Everything parents need to support learning at home
</h2>
